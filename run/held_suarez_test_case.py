...
RESTART = True if "rue" in os.environ['RESTART'] else False
...
if __name__ == '__main__':
    # MODIFIED - used to be for 1 year with use_restart = False
    exp.run(1, num_cores=NCORES, use_restart=RESTART)
