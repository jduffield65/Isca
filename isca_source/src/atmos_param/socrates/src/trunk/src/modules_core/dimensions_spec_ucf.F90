...
! Numer of excluded bands - CHANGED FROM ORIGINAL VALUE OF 150
INTEGER, PARAMETER :: npd_k_term = 14
! Number of esft terms
INTEGER, PARAMETER :: npd_type = 20
! Number of data types
INTEGER, PARAMETER :: npd_species = 11
! Number of gaseous species - CHANGED FROM ORIGINAL VALUE OF 10
INTEGER, PARAMETER :: npd_scale_variable = 4
! Number of scaling variables - CHANGED FROM ORIGINAL VALUE OF 4
INTEGER, PARAMETER :: npd_continuum = 2
! Number of continua - CHANGED FROM ORIGINAL VALUE OF 6
...
! Number of temperature datapoints - CHANGED FROM ORIGINAL VALUE OF 504
...
! Number of gas fractions - CHANGED FROM ORIGINAL VALUE OF 501
! A large value of this significantly increases memory usage and makes ISCA slow.
