...
# ${11} - Dependency i.e. job ID that must be finished for job to be submitted
# ${12} - Arguments to be passed to python script (if multiple, will also be ${13}, ${14}, ...)
...
python ${10} ${@:12}                    # run python script with all but first 10 arguments as input to script
